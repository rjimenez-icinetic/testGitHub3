...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:(NSObject<RODatasource> *)[[DatasourceManager sharedInstance] sheetDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"lstDetail"];
...
- (void)loadDataSuccess:(Sheet1Schema1Item *)item {
