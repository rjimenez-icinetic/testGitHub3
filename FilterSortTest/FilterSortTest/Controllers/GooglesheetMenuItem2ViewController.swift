//
//  GooglesheetMenuItem2ViewController.swift
//  FilterSortTest
//
...
class GooglesheetMenuItem2ViewController: TableViewController<Hoja1Item>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		let sortOptions = DatasourceSortOptions(field: Hoja1ItemMapping.name, ascending: false)
        datasourceOptions = DatasourceOptions(sortOptions: sortOptions)
		
		dataResponse = self
		
		behaviors.append(FilterBehavior<GooglesheetMenuItem2FilterViewController>(viewController: self))
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
		...
		cell.detailLabel.text = String(double: item.performance)
...
extension GooglesheetMenuItem2ViewController: DataResponse {
