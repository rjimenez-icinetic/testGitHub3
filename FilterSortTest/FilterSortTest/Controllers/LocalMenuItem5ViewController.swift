//
//  LocalMenuItem5ViewController.swift
//  FilterSortTest
//
...
class LocalMenuItem5ViewController: TableViewController<LocalDSDSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<LocalMenuItem5FilterViewController>(viewController: self))
...
extension LocalMenuItem5ViewController: DataResponse {
