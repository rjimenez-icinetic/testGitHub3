//
//  LocalMenuItem3ViewController.swift
//  FilterSortTest
//
...
class LocalMenuItem3ViewController: TableViewController<LocalDSDSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<LocalMenuItem3FilterViewController>(viewController: self))
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = LocalMenuItem3DetailViewController()
...
extension LocalMenuItem3ViewController: DataResponse {
