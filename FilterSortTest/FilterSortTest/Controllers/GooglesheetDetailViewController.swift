//
//  GooglesheetDetailViewController.swift
//  FilterSortTest
//
...
class GooglesheetDetailViewController: DataViewController<Hoja1Item> {
	...
	override func viewDidLoad() {
		...
		titleLabel2Header = createHeaderLabel("location")
		addSubview(titleLabel2Header)	
		
		titleLabel2 = createLabel()
		addSubview(titleLabel2)	
		
		titleLabel3Header = createHeaderLabel("sales")
...
extension GooglesheetDetailViewController: DataResponse {
    ...
    func success() {
		...
		titleLabel2.text = item?.location
		
		titleLabel3.text = String(double: item?.sales)
