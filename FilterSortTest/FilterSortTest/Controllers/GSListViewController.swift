...
class GSListViewController: TableViewController<Hoja1Item>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
        ...
        datasourceOptions.addDesignFilter(datasource?.datasourceFilter.create(Hoja1ItemMapping.name, string: "Palo"))
		
		dataResponse = self
		
		behaviors.append(FilterBehavior<GSListFilterViewController>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("GSList")
        title = NSLocalizedString("GSList", comment: "")
...
extension GSListViewController: DataResponse {
