//
//  BuildupListViewController.swift
//  FilterSortTest
//
...
class BuildupListViewController: TableViewController<DoubleFilterBCScreen1DSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
        ...
        datasourceOptions.addDesignFilter(datasource?.datasourceFilter.create(DoubleFilterBCScreen1DSItemMapping.text2, string: "2"))
		
		dataResponse = self
		
		behaviors.append(FilterBehavior<BuildupListFilterViewController>(viewController: self))
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("BuildupList")
        title = NSLocalizedString("BuildupList", comment: "")
...
extension BuildupListViewController: DataResponse {
