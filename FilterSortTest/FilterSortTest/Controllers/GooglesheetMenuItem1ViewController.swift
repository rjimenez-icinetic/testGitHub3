//
//  GooglesheetMenuItem1ViewController.swift
//  FilterSortTest
//
...
class GooglesheetMenuItem1ViewController: TableViewController<Hoja1Item>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		let sortOptions = DatasourceSortOptions(field: Hoja1ItemMapping.name, ascending: true)
        datasourceOptions = DatasourceOptions(sortOptions: sortOptions)
		
		dataResponse = self
		
		behaviors.append(FilterBehavior<GooglesheetMenuItem1FilterViewController>(viewController: self))
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
		...
		cell.detailLabel.text = String(double: item.sales)
...
extension GooglesheetMenuItem1ViewController: DataResponse {
