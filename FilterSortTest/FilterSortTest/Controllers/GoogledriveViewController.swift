...
class GoogledriveViewController: TableViewController<GoogleDriveScreen1DSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<GoogledriveFilterViewController>(viewController: self))
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = GoogledriveDetailViewController()
...
extension GoogledriveViewController: DataResponse {
