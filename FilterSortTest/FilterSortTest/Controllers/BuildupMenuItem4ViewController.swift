//
//  BuildupMenuItem4ViewController.swift
//  FilterSortTest
//
...
class BuildupMenuItem4ViewController: TableViewController<BuildupCloudDSDSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<BuildupMenuItem4FilterViewController>(viewController: self))
...
extension BuildupMenuItem4ViewController: DataResponse {
