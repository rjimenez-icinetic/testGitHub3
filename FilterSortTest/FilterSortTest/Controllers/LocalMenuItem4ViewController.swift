//
//  LocalMenuItem4ViewController.swift
//  FilterSortTest
//
...
class LocalMenuItem4ViewController: TableViewController<LocalDSDSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<LocalMenuItem4FilterViewController>(viewController: self))
...
extension LocalMenuItem4ViewController: DataResponse {
