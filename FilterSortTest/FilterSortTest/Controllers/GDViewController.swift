...
class GDViewController: TableViewController<GoogleDriveScreen1DSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("GD")
        title = NSLocalizedString("GD", comment: "")
...
extension GDViewController: DataResponse {
