//
//  GoogledriveMenuItem2ViewController.swift
//  FilterSortTest
//
...
class GoogledriveMenuItem2ViewController: TableViewController<GoogleDriveScreen1DSSchemaItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		let sortOptions = DatasourceSortOptions(field: GoogleDriveScreen1DSSchemaItemMapping.title, ascending: true)
        datasourceOptions = DatasourceOptions(sortOptions: sortOptions)
		
		dataResponse = self
		
		behaviors.append(FilterBehavior<GoogledriveMenuItem2FilterViewController>(viewController: self))
...
extension GoogledriveMenuItem2ViewController: DataResponse {
