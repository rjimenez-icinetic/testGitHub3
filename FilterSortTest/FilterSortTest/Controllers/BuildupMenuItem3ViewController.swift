//
//  BuildupMenuItem3ViewController.swift
//  FilterSortTest
//
...
class BuildupMenuItem3ViewController: TableViewController<BuildupCloudDSDSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override init() {
		...
		behaviors.append(FilterBehavior<BuildupMenuItem3FilterViewController>(viewController: self))
...
extension BuildupMenuItem3ViewController: DataResponse {
